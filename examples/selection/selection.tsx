...
const Selection = forwardRef<SelectionReference>((_, reference) => {
		...
		<Box flexDirection="column">
			...
			<Box>
				<Text>
					anchorPoint:{' '}
					{state.anchorPoint
						? `${state.anchorPoint.offset}, ${state.anchorPoint.node.nodeValue}`
						: 'undefined'}
				</Text>
			</Box>
			<Box>
				<Text>
					focusPoint:{' '}
					{state.focusPoint
						? `${state.focusPoint.offset}, ${state.focusPoint.node.nodeValue}`
						: 'undefined'}
				</Text>
			</Box>
