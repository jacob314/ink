...
test('interactive scroll', async t => {
	...
	let {callCount} = write; // eslint-disable-line @typescript-eslint/no-unsafe-assignment
	...
	callCount = write.callCount; // eslint-disable-line @typescript-eslint/no-unsafe-assignment
