...
import {getScrollHeight} from '../src/scroll.js';
...
test('stableScrollback keeps scrollHeight stable when content shrinks', t => {
...
test('getAddedScrollHeight returns the amount of padding added', t => {
	let rootRef: DOMElement | undefined;
...
test('stableScrollback maintains maxScrollTop when viewport grows', t => {
	let rootRef: DOMElement | undefined;
